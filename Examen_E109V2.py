...
# ---------- Config ----------
PING_INTERVAL = 5        # sec: server stuurt PING elke 5s
TIMEOUT_SECONDS = 10     # sec: als geen PONG binnen deze tijd → offline
...
def handle_pong():
    # update laatste tijd voor alle clients
